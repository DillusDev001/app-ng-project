...
import { goForGotPassword, goLogin, goRegister } from 'src/app/shared/utils/local.router';
...
export class LoginComponent {
  ...
  onClickRegister() {goRegister(this.router); }

  onClickGoForGotPasswrd() { goForGotPassword(this.router); }
